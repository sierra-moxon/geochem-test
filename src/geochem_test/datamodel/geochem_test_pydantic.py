...
linkml_meta = LinkMLMeta({'default_prefix': 'geochem_test',
     ...
     'prefixes': {'PATO': {'prefix_prefix': 'PATO',
                  ...
                  'geochem_test': {'prefix_prefix': 'geochem_test',
                                   'prefix_reference': 'https://w3id.org/sierra-moxon/geochem-test/'},
                  'linkml': {'prefix_prefix': 'linkml',
                             'prefix_reference': 'https://w3id.org/linkml/'},
                  'schema': {'prefix_prefix': 'schema',
                             'prefix_reference': 'http://schema.org/'}},
     'see_also': ['https://sierra-moxon.github.io/geochem-test'],
     'source_file': 'src/geochem_test/schema/geochem_test.yaml',
     'title': 'geochem-test'} )
...
class NamedThing(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'schema:Thing',
         'from_schema': 'https://w3id.org/sierra-moxon/geochem-test'})
...
class Person(NamedThing):
    ...
    Represents a Person
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/sierra-moxon/geochem-test',
...
class PersonCollection(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/sierra-moxon/geochem-test', 'tree_root': True})
