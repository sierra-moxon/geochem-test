# Contributing to geochem-test

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
geochem-test. These guidelines are not strict rules.
...
The geochem-test team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the geochem-test technical leads
...
[issues]: https://github.com/sierra-moxon/geochem-test/issues/
[pulls]: https://github.com/sierra-moxon/geochem-test/pulls/
